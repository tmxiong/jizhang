...
class AfMyCollectScreen extends React.Component {
  ...
  getProductTotalListNew(){
    var that = this;
    var url_fetch = Global.requestDomain+"/Index/Product/getUserCollectProductRecord";
    ...
    fetch(url_fetch, {
      ...
      //console.warn(responseJson);return;
  ...
  initSelectedOption(){
    var that = this;
    this.setState({search_order_condition:'',selectedValue:''});
    that.getProductTotalListNew();
  }
  ...
  getSignleBox(){
    ...
    var attrData = that.state.pageData.collect_product_list;
...
export default AfMyCollectScreen
