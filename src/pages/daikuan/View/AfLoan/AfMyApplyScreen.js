...
class AfMyApplyScreen extends React.Component {
  ...
  getProductTotalListNew(){
    var that = this;
    var url_fetch = Global.requestDomain+"/Index/Product/getUserApplyRecord";
  ...
  getSignleBox(){
    ...
    var attrData = that.state.pageData.product_apply_list;
...
export default AfMyApplyScreen
