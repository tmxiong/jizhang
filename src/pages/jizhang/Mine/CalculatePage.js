        ...
        return (
            <View style={styles.container}>
                <TouchableOpacity
                    ...
                    style={{position:'absolute',left:5,top:5,width:80,height:80,justifyContent:'center',alignItems:'center'}}>
                ...
                <View style={styles.itemView}>
                    <View style={styles.keyWrap}>
                        <TouchableHighlight activeOpacity={0.8} onPress={() => { this.press('ac') }} style={[styles.touchBtn, styles.gray]}>
