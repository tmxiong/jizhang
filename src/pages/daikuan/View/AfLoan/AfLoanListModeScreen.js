...
class AfLoanListModeScreen extends React.Component {
  ...
  getProductTotalListNew(){
    ...
    var requestParam = Global.requestParam+"&p=1&attr_id="+that.state.attr_id+"&search_order_condition="+JSON.stringify(that.state.search_order_condition);
...
export default AfLoanListModeScreen
